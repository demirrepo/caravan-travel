...
import Hero from '@/components/Hero' // <-- We import your new Hero component here!
...
export default async function Home() {
  ...
  return (
    <>
      ...
      {/* We replaced 80+ lines of code with this single, clean line! */}
      <Hero tours={tours || []} waNumber={waNumber} />
